...
void navigation::nodeTracker(){

}

void navigation::sensorCallback(const hardware_msgs::IRDists msg1){
...
void navigation::odometryCallback(const hardware_msgs::Odometry msg2){
    absX = msg2.totalX;
    absY = msg2.totalY;
    theta = msg2.latestHeading;
}

/*void navigation::poseCallback(const geometry_msgs::PoseStamped msg3){

}*/

void navigation::calculatePID(){
    // Left side sensors:
    if(sensor[0] < 0){
		sensor[0] = 0.04;
	}
...
int main(int argc, char *argv[]){
    navigation navigation(argc, argv);
}
